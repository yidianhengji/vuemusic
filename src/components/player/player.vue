          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper">
                <img ref="image" :class="cdCls" class="image" :src="currentSong.al.picUrl">
              </div>
            </div>
            <div class="playing-lyric-wrapper">
              <div class="playing-lyric">ddd</div>
            </div>
          </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <div class="imgWrapper" ref="miniWrapper">
            <img ref="miniImage" :class="cdCls" width="40" height="40" :src="currentSong.al.picUrl">
          </div>
        </div>
        <div class="text">
...
<script type="text/ecmascript-6">
  ...
  import { getSongUrl, getSongLyric } from 'api/player'
  ...
  export default {
    ...
    methods: {
      ...
      _getSongLyric() {
        ...
        getSongLyric(params).then((res) => {
          if (res.data.code === ERR_OK) {
            let lyricList = res.data.lrc.lyric
            this.currentLyric = new Lyric(lyricList, this.handleLyric)
